...
export function ComponentsScreen() {
    ...
    return (
        ...
        >
            ...
            <View className="w-full gap-3 px-5 py-5">
                ...
                <View className="gap-3">
                    ...
                    <Caption color="alert">
                        Caption with alternative color
                    </Caption>
                ...
                <View>
                    ...
                    <View className="flex-row items-center gap-3">
                        <IconButton
                            ...
                            onPress={() =>
                                Alert.alert(
                                    'xs outlined icon button pressed',
                                )
                            }
                        />
                        ...
                        <IconButton
                            ...
                            onPress={() =>
                                Alert.alert(
                                    'sm outlined icon button pressed',
                                )
                            }
                        />
                        ...
                        <IconButton
                            ...
                            onPress={() =>
                                Alert.alert(
                                    'md outlined icon button pressed',
                                )
                            }
                        />
                        ...
                        <IconButton
                            ...
                            onPress={() =>
                                Alert.alert(
                                    'lg outlined icon button pressed',
                                )
                            }
                        />
                        ...
                        <IconButton
                            ...
                            onPress={() =>
                                Alert.alert(
                                    'xl outlined icon button pressed',
                                )
                            }
                        />
                    </View>
            ...
            <View className="w-full gap-5 px-5 py-5">
